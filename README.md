 ...
 * Per the graph: As the value of $h$ gets smaller, the abs. error shrinks until it hits a minimum value, and then begins to increase again due to precision errors. 
